...
$api_key="59f70e8de8754e818f7c629e6a3faaee";
 
//Url api untuk ambil berita headline di Indonesia
$url="https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=".$api_key;
        ...
        <div class="col-md" style="margin-top: 10px; margin-bottom: 10px;">
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <p class="text-right"><a href="<?php echo $row['urli']; ?>" target="_blank">Selengkapnya..</a></p>
              </div>
            </div>
        </div>
